...
The supply elasticity for total quantity is approximately 0.9 and that for area is 0.63. The difference stems from log(yield) which is ln_qs - ln(area). The mean of log(yield) is 2.13 ranging from 1.57 to 2.57. The correlation of ln_qs and log(area) is almost one.
